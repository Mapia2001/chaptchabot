	                ...
	                <div class="col-sm-6 col-sm-offset-3 col-xs-offset-0">
	                    <div class="card no-border">
	                        <div id="chat" class="conv-form-wrapper">
	                            <form action="processform.php" method="POST" class="hidden">
	                                <select data-conv-question="Hello! I'm a bot. Can I show you some features? (this question comes from a select)" name="first-question">
	                                ...
	                                <input type="text" data-conv-question="This bot supports multi-select too. Let's see an example." data-no-answer="true">
	                                ...
	                                <input type="text" data-conv-question="have made it to also supports regex patterns. Look:" data-no-answer="true">
	                                ...
	                                <select data-conv-question="This is it! If you like me, consider donating! If you need support, contact me. When the form gets to the end,it submits it normally, like you had filled it." id="">
	                                    <option value="" onclick="processForm();">Awesome!</option>
	                                </select>
	                            </form>
	                        </div>
	                    </div>
